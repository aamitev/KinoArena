...
<body>
 ...
 <div class="page_bg" style="background-image: url('/images/frontend/bg-items/bg-15years.jpg');"></div>
    ...
    <section class="pageDesc profile">
        ...
        <article class="content">
            <p><img src="/images/frontend/content/register_pros1.png" alt="" /> <img src="/images/frontend/content/register_pros2.png" alt="" /> <img src="/images/frontend/content/register_pros3.png" alt="" /></p>
        </article>
    </section>
    <div class="wrapper">
                    ...
                    <ul>
                        <li >
                            <a href="./userProfile">
                                ...
                                <span class="txt">Персонална информация</span>
                            </a>
                        </li>
                        <li >
                            <a href="./changePassword">
                                <span class="icon"><i class="password"></i></span>
                                <span class="txt">Промяна на парола</span>
                            </a>
                        </li>
                        <li >
                            <a href="./interests">
                                <span class="icon"><i class="popcornPack"></i></span>
                                <span class="txt">Интереси</span>
                            </a>
                        </li>
                        <li >
                            <a href="./favorites">
                                <span class="icon"><i class="heart"></i></span>
                                <span class="txt">Моите филми</span>
                            </a>
                        </li>
                        <li class="selected">
                                <span class="icon"><i class="email"></i></span>
                                <span class="txt">Абонирай се за нашия е-бюлетин</span>
                        </li>
                        <li >
                            <a href="./orders">
                                <span class="icon"><i class="clock"></i></span>
                                <span class="txt">История на резервациите и закупените билети</span>
                            </a>
                        </li>
                        <li>
                            <a href="./logout">
        ...
        <img src="./images/frontend/profile-newsletter.png" alt="bg image" class="bgImage">
        <div class="content">
            <p>Тук можете да променяте избора на новини, за които сте абониран или да откажете абонамента си за електронен бюлетин.</p>
            <form action="./newsletter" method="POST" class="stdForm">
                <div class="clearH"></div>
                <div class="formItem checkbox">
                    <input type="checkbox"  name="newsletter" id="user_newsletter_subscribe">
                    <label for="user_newsletter_subscribe">Абонамент за новини, промоции и игри</label>
                </div>
                <div class="clearH2"></div>
                <div class="formItem checkbox">
                    <input type="checkbox"  name="newsletter_for_promos" id="user_newsletter_for_promos_subscribe">
                    <label for="user_newsletter_for_promos_subscribe">Абонамент за промоции и оферти</label>
                </div>
                <div class="clearH2"></div>
                <div class="formItem checkbox">
                    <input type="checkbox"  name="newsletter_for_news" id="user_newsletter_for_news_subscribe">
                    <label for="user_newsletter_for_news_subscribe">Абонамент за новини и събития</label>
                </div>
                <div class="clearH2"></div>
        ...
        <div class="bottom">
            <div class="socialLinks">
                                    <a href="http://facebook.com/KinoArena" class="item"><i class="facebook"></i></a>
                                                    <a href="https://www.pinterest.com/kinoarena" class="item"><i class="pinterest"></i></a>
        ...
        <script>
            ...
            function onYouTubeIframeAPIReady() {
                ...
                $videoHandles.click(function(e) {
                    ...
                    TweenLite.fromTo($playerHolder, 0.3, {y: -100, opacity: 0}, { y: 0, opacity: 1, delay: 0.2, onComplete: function() {
                        youtubeInit();
                    } });
                });
                ...
                $videoClose.on('click', function() {
                    TweenLite.to($playerHolder, 0.3, { y: -100, opacity: 0, ease:Back.easeIn, onComplete: function() {
...
<script>
    ...
    jQuery(function($){
        ...
        $dateOfBirth.val(addZero(date.getDate()) + '.' + addZero((date.getMonth() + 1)) + '.' + date.getFullYear());
    });
</script>
