		...
		<div class="wrapper">
			<div class="profilePanel">
				...
				<div class="contentWrapper">
					...
					<img src="/KinoArena/images/profile-newsletter.png" alt="bg image"
						class="bgImage">
					<div class="content">
						<p>Тук можете да променяте избора на новини, за които сте
							абониран или да откажете абонамента си за електронен бюлетин.</p>
						<form action="./newsletter" method="POST" class="stdForm">
							<div class="clearH"></div>
							<div class="formItem checkbox">
								<input type="checkbox" name="newsletter"
									id="user_newsletter_subscribe"> <label
									for="user_newsletter_subscribe">Абонамент за новини,
									промоции и игри</label>
							</div>
							<div class="clearH2"></div>
							<div class="formItem checkbox">
								<input type="checkbox" name="newsletter_for_promos"
									id="user_newsletter_for_promos_subscribe"> <label
									for="user_newsletter_for_promos_subscribe">Абонамент за
									промоции и оферти</label>
							</div>
							<div class="clearH2"></div>
							<div class="formItem checkbox">
								<input type="checkbox" name="newsletter_for_news"
									id="user_newsletter_for_news_subscribe"> <label
									for="user_newsletter_for_news_subscribe">Абонамент за
									новини и събития</label>
							</div>
							<div class="clearH2"></div>
